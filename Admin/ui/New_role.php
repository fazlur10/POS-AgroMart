                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <form method="POST" action="#" id="cfrm" class="form-horizontal" data-toggle="validator">
                                    ...
                                    <div class="form-group" style="display:none;"><label class="col-lg-2 control-label">Role ID</label>
                                        <div class="col-lg-10"><input type="text" name="rid" readonly="" placeholder="" class="form-control" value="<?php echo($res); ?>"></div>
                                    </div>

                                    <div class="form-group"><label class="col-sm-2 control-label">Role</label>
                                        <div class="col-sm-10"><input type="text" name="ro" placeholder="Role" class="form-control" data-bv-regexp="true" data-bv-regexp-message="Please enter a valid Name" pattern="^([a-zA-Z ]{2,15})$" required/></div>
                                    </div>
                                        ...
                                        <?php
                                            include_once("../lib/c_role.php");
                                                ...
                                                $c1=$rol->view_role();
                                                    ...
                                                    if(!empty($c1)){
                                                        foreach ($c1 as $item){
                                                            echo("<tr id='tr_$item->role_id'>
                                                                <td>$item->role_id</td>
                                                                <td>$item->role_name</td>
                                                                <td>$item->state</td>
                                                                <td>
                                                                <span class='glyphicon glyphicon-edit text-primary' onclick='edit(\"$item->role_id\")'></span>
                                                                <span class='glyphicon glyphicon-trash text-danger' onclick='del(\"$item->role_id\")'></span>
                                                                <span class='glyphicon glyphicon-check text-success' onclick='act(\"$item->role_id\")'></span>
                                                                </td>
                                                                </tr>");
                                                        }
                                                    } 
...
<script>
    function edit(role_id) {
        swal({
            ...
            window.location.href="update_role.php?role_id="+role_id;
        });
    }
    ...
    function del(role_id){
        swal({
            ...
            window.location.href="../handeler/role_ctrl.php?type=deactive_role&role_id="+role_id;
        });  
    }

    function act(role_id){
        swal({
            title: "Are you sure?",
            ...
            window.location.href="../handeler/role_ctrl.php?type=Active_role&role_id="+role_id;
        });
    }
</script>
