        ...
        $('.dataTables-example').DataTable({//dataTables plugin
            ...
            "buttons": [
                ...
                {extend: 'print',
                    ...
                    messageTop:'<img src="img/Header.jpg" width="100%"><br><div class="pull-right"><br><?="Date-Time : ". date("Y-m-d / h:i a")?></div><div class="text-center"><br><h1>Active Customer List Report</h1><br></div>',
