                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" >
                                    ...
                                    <tbody>
                                        <?php
                                            include_once("../lib/c_reports.php");
                                                $re=new report;
                                                    $c1=$re->sales_by_date($sdate, $edate);
                                                        if(!empty($c1)){
...
<script>
    $(document).ready(function(){
        ...
        $('.dataTables-example').DataTable({//dataTables plugin
            ...
            "order": [[0,"desc"]],
            "buttons": [
                {extend: 'pdf', title: 'Sales By Date Report - '+date,
                    exportOptions: {
                ...
                {extend: 'print',
                    ...
                    messageTop:'<img src="img/Header.jpg" width="100%"><br><div class="pull-right"><br><?="Date-Time : ". date("Y-m-d / h:i a")?></div><div class="text-center"><br><h1>Sales By Date Report</h1><br></div>',
